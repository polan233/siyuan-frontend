...
import { getMenu, getAuthorPath, getTextInfo,getAuthorIntroduction } from './axios/api';
...
class MainContent extends React.Component{
    ...
    getRightContent(){
        ...
        this.props.selectedAuthor!==""&&this.props.selectedAuthor!==null)
      {
        ...
        getTextInfo(this.props.selectedTitle).then((res)=>{
          const data=res.data.data;
          console.log("getTextInfo",data);
          this.setState({
            picUrl:data.illustratingPicture,
          })
        })
      }
    }
    ...
    render(){
      ...
      let img=
        ...
        />
      if(this.props.selectedAuthor==null||this.props.selectedAuthor==undefined||imgurl==""||imgurl==null||imgurl==undefined){
        img=null;
      }
      return(
        <div className='mainContent'>
          <Layout>
            ...
            <Sider style={siderStyle}>
              <Card className='info' bordered={true} title={this.props.selectedAuthor+"生平简介"}>
                {img}
                <Typography>
                  {/* 现在这里放作者简介 */}
                  {/* <img src='http://siyuanmap.oss-cn-shanghai.aliyuncs.com/author/鲁迅5' alt='作者图片' style={{width:50,height:50}}></img> */}
                  
                  {/* <Paragraph 
                    className='authorIntroduction'
                    ellipsis={{
                      rows:10,
                      expandable:true,
                    }}
                  ...
                  <FoldableText  maxRow={20} text={this.state.rightContent}></FoldableText>
                </Typography>
              </Card>
            </Sider>
            </Layout>
